...
var requests_1 = __importDefault(require("../models/requests"));
var RequestController = /** @class */ (function () {
    function RequestController() {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, requests_1.default.find({ companyId: companyId })];
                    case 1:
                        requests = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        companyId = req.params.companyId;
                        return [4 /*yield*/, requests_1.default.find({ companyId: companyId, status: 'outstanding' })];
                    case 1:
                        requests = _a.sent();
                        res.status(200).json({ data: requests });
                        return [3 /*break*/, 3];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, requests_1.default.find({ requestorCompanyId: requestorCompanyId, type: 'incoming' })];
                    case 1:
                        requests = _a.sent();
                        res.status(200).json({ data: requests });
                        return [3 /*break*/, 3];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = req.params.id;
                        return [4 /*yield*/, requests_1.default.findByIdAndUpdate(id, req.body, { new: true })];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = req.params.id;
                        return [4 /*yield*/, requests_1.default.findByIdAndDelete(id)];
                    case 1:
        ...
        this.updateCompanyRequest = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var requestId, updatedRequest, error_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
