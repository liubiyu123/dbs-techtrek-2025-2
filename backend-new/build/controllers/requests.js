    ...
    constructor() {
        ...
        this.getAllCompanyRequests = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const requests = yield requests_1.default.find({ userId });
        ...
        this.updateCompanyRequest = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { requestId } = req.body;
                const updatedRequest = yield requests_1.default.findByIdAndUpdate(requestId);
                if (!updatedRequest) {
