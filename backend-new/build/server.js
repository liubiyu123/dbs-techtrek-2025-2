...
const account_1 = __importDefault(require("./routes/account")); // If using ES Modules (with "type": "module" in package.json)
...
exports.app.use("/api/requests", requests_1.default);
